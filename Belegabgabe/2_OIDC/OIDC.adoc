...
_Abbildung: OpenID Connect Flow, auf Basis (Referenz) von (\https://images.pingidentity.com/image/upload/f_auto,q_80,w_778,c_scale/ping_dam/content/dam/ping-6-2-assets/images/resources/articles/oidc-diagram.png) (Quelle)_
