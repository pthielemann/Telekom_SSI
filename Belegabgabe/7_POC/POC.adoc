...
image::./7_POC/img/erstellung.png[Provisionierung,70%,70%]
...
image::./7_POC/img/schema.png[Schema,70%,70%]
...
image::./7_POC/img/einladung.png[Einladung,70%,70%]
...
image::./7_POC/img/verbindung.png[Verbindungsaufbau,40%,40%]
...
image::./7_POC/img/issues.png[Ausstellung,40%,40%]
...
image::./7_POC/img/credentials.png[Speicherung,40%,40%]
...
image::./7_POC/img/proof.png[Nachweis,40%,40%]
